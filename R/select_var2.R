...
selectVarApp2 <- function(filter = is.numeric) {
  ui <- fluidPage(
  ...
  server <- function(input, output, session) {
    ...
    var <- selectVarServer2("var", data, filter = filter)
...
selectVarServer2 <- function(id, data, filter = is.numeric) {
